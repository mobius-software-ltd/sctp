...
public class ClientAssociationTest {
	private static final Logger logger = LogManager.getLogger(ClientAssociationTest.class);
    ...
    public static void setUpClass() throws Exception {
    	...
    	logger.info("Starting " + ClientAssociationTest.class.getName());
    }

    @AfterClass
    public static void tearDownClass() throws Exception {
    	logger.info("Stopping " + ClientAssociationTest.class.getName());
    }
